...
mutual
  ...
  IntChoice+ : (i : Size) → {c₀ : Choice} → (c : Choice) 
          → (P : ChoiceSet c → Process∞ (↑ i) (ChoiceSet c₀)) 
          → Process+ (↑ i) (ChoiceSet c₀)  
  E   (IntChoice+ i {c₀} c P)    = empty
  Lab (IntChoice+ i {c₀} c P)    = efq 
  PE  (IntChoice+ i {c₀} c P)    = efq 
  I   (IntChoice+ i {c₀} c P)    = c
  PI  (IntChoice+ i {c₀} c P)    = P 
  T   (IntChoice+ i {c₀} c P)    = empty
  PT  (IntChoice+ i {c₀} c P)    = efq      
  Str (IntChoice+ i {c₀} c P)    = " \t ⊔ \t " ++s funcChoice2ProcessToProcess₁∞ c P
