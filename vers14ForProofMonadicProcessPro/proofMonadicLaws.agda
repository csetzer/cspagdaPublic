...
monadicLaw₁₋₁ₐ : {i : Size} {c₀ c₁  : Choice} (a : ChoiceSet c₀)(P : ChoiceSet c₀ → Process i c₁)
               → (terminate a ⟫= P)  ⊑  P a
monadicLaw₁₋₁ₐ {i} {c₀} {c₁} a P l m q = q



monadicLaw₁₋₁ᵣ : {i : Size} {c₀ c₁  : Choice} (a : ChoiceSet c₀)(P : ChoiceSet c₀ → Process i c₁)
               → P a ⊑ (terminate a ⟫= P)
monadicLaw₁₋₁ᵣ {i} {c₀} {c₁} a P l m q = q
...
mutual
  monadicLaw₁₋₂ : {i : Size} {c₀  : Choice} (P : Process i c₀)
                 → (P  ⟫=  terminate)  ⊑  P
  monadicLaw₁₋₂ {i} {c₀} (terminate x) l m q = q
  monadicLaw₁₋₂ {i} {c₀} (node x) l m q = tnode (monadicLaw₁₋₂₊ x l m (forcet' l m q))


  monadicLaw₁₋₂₊ : {i : Size} {c₀  : Choice} (P : Process+ i c₀)
                 → (P  ⟫=+  terminate)  ⊑+  P
  monadicLaw₁₋₂₊ {i} {c₀} P .[] .nothing empty = empty
  monadicLaw₁₋₂₊ {i} {c₀} P .(Lab P x ∷ l) m (extc l .m x x₁) = extc l m x (monadicLaw₁₋₂∞ (PE P x) l m x₁)
  monadicLaw₁₋₂₊ {i} {c₀} P l m (intc .l .m x x₁) =  intc l m (inj₁ x) (monadicLaw₁₋₂∞ (PI P x) l m x₁)
  monadicLaw₁₋₂₊ {i} {c₀} P .[] .(just (PT P x)) (terc x) = intc [] (just (PT P x)) (inj₂ x) (lemTrTerminateBind i c₀ P x)


  monadicLaw₁₋₂∞ : {i : Size} {c₀  : Choice} (P : Process∞ i c₀)
                 → (P  ⟫=∞  terminate)  ⊑∞  P
  forcet (monadicLaw₁₋₂∞ {i} {c₀} P l m q) = monadicLaw₁₋₂ (forcep P) l m (forcet q)
...
mutual
  ...
  monadicLaw₁₋₃∞ : {i : Size} {c₀ c₁ c₂ : Choice} (P : Process∞ i c₀)
                 ...
                 (R : ChoiceSet c₁ → Process i c₂)
                 → ((P  ⟫=∞  Q) ⟫=∞ R)  ⊑∞  (P  ⟫=∞  ( λ x → Q x ⟫= R ))
  forcet (monadicLaw₁₋₃∞ {i} {c₀} {c₁} {c₂} P Q R l m q) {j} = {!!} -- monadicLaw₁₋₃ (forcep P) Q R l m {!!}
  ...
  monadPT {i} {j} {c₀} {c₁} {c₂} P Q R l m x₁ = {!P!}
