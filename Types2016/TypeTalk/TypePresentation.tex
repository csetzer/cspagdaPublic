...
\begin{frame}
\frametitle{Example Of Process Algebras } % Table of contents slide, comment this block out to remove it
\begin{center}
...
%\item Concurrent execution of processes P and Q where no such synchronization is described by the combination $ P \;|||\; Q$
